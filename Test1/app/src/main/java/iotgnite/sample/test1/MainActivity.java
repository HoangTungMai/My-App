...
import iotgnite.sample.test1.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo CognitoCachingCredentialsProvider
        CognitoCachingCredentialsProvider credentialsProvider = new CognitoCachingCredentialsProvider(
                getApplicationContext(),
                "ap-northeast-2:b1178f12-7d4b-4d29-a70f-4f4b94f2a9db",
                Regions.AP_NORTHEAST_2
        );

        // Create an AmazonDynamoDBClient object using the Cognito credentials
        AmazonDynamoDBClient dbClient = new AmazonDynamoDBClient(credentialsProvider);

        // Create a table reference
        Table dbTable = Table.loadTable(dbClient, "Stand");

        System.out.println("Hello World");

        // create a memo
        Document memo = new Document();
        memo.withString("case1", "10");
        memo.withString("case2", "20");
